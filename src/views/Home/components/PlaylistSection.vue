<template>
  <div class="playlist-section px-4 md:px-6 py-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6 md:gap-8">
      <div
      ...
      >
        <!-- 背景光效 -->
        <div
          class="absolute -inset-4 rounded-2xl bg-gradient-to-br from-primary/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"
